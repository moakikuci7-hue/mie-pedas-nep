...
<head>
    ...
    <style>
        ...
        .badge-kategori { background: #fff5f5; color: #dc3545; padding: 5px 12px; border-radius: 20px; font-size: 0.8rem; }
    </style>
</head>
<body>
    ...
    <div class="content">
        <div class="d-flex justify-content-between align-items-center mb-4">
            <div>
                ...
                <p class="text-muted small">Kelola data warung Mie Padeh kamu di sini.</p>
            </div>
            <a href="tambah.php" class="btn btn-padeh"><i class="fa fa-plus me-2"></i> Tambah Menu</a>
        </div>
        ...
        <div class="table-container text-center">
            <h5 class="fw-bold mb-4 text-start">Daftar Menu Saat Ini</h5>
                ...
                <table class="table table-hover align-middle ">
                    ...
                    <tbody>
                        ...
                        <tr style="font-size: 0.95rem;">
                            <td><?= $no++; ?></td>
                            <td class="fw-medium text-start"><?= $row['nama_menu']; ?></td>
                            <td><span class="badge-kategori"><?= $row['kategori']; ?></span></td>
                            <td>Rp <?= number_format($row['harga'], 0, ',', '.'); ?></td>
                            <td><?= $row['stok']; ?> <small class="text-muted">pcs</small></td>
                            <td class="text-center">
                                <a href="edit.php?id=<?= $row['id_menu']; ?>" class="btn btn-sm btn-outline-primary border-0"><i class="fa fa-edit"></i></a>
                                <a href="hapus.php?id=<?= $row['id_menu']; ?>" onclick="return confirm('Yakin ingin menghapus menu ini?')" class="btn btn-sm btn-outline-danger border-0"><i class="fa fa-trash"></i></a>
                            </td>
                        </tr>
                        <?php } ?>
                    </tbody>
